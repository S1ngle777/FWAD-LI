...
INSERT INTO migrations VALUES(5,'2024_12_03_131517_create_products_table',1);
INSERT INTO migrations VALUES(6,'2024_12_03_131521_create_categories_table',1);
INSERT INTO migrations VALUES(7,'2024_12_03_131523_create_orders_table',1);
INSERT INTO migrations VALUES(8,'2024_12_03_131526_create_order_items_table',1);
INSERT INTO migrations VALUES(9,'2024_12_03_165321_add_role_to_users_table',1);
...
INSERT INTO users VALUES(1,'Admin','admin@gmail.com',NULL,'$2y$10$Bbnh/sHHbdjOKhyvyiVObepuYyD36/Rc5R37SEHUv.PAIPIRewzYS',NULL,'2024-12-04 00:06:53','2024-12-04 00:06:53','admin');
...
INSERT INTO products VALUES(2,'Брошь "Молдавский узор"','bros-moldavskii-uzor','Handmade брошь с традиционным молдавским орнаментом, выполненная из бисера и металла',350,10,2,'products/PZW3M3Q1oXbv3BeYdJ4SH09Fksb1m6zAVKf3f776.jpg','2024-12-04 15:07:33','2024-12-04 15:07:33');
INSERT INTO products VALUES(3,'Серьги "Виноградная лоза"','sergi-vinogradnaia-loza','Серьги ручной работы в виде виноградной лозы из серебра 925 пробы',450,5,2,'products/bdmIA5BIhSCmoHjLVhXxStvVonpBXjZZ26eaUmyC.jpg','2024-12-04 15:09:29','2024-12-04 15:09:29');
...
CREATE TABLE IF NOT EXISTS "orders" ("id" integer primary key autoincrement not null, "user_id" integer not null, "total_amount" numeric not null, "status" varchar not null, "created_at" datetime, "updated_at" datetime, foreign key("user_id") references "users"("id") on delete cascade);
